...
- intent: Keep DTP patient copy empathetic, second-person and life-focused rather than clinical.

### rule_ibsrela_ibsc_symptoms_terminology
...
- intent: Enforce MLR-approved symptom terminology and consistent naming of the three symptoms.
...
- intent: Ensure required patient-story disclosure appears verbatim beneath testimonial copy.

### rule_ibsrela_efficacy_claim_qualifier_verbatim
...
- intent: Attach required MLR qualifier and limitation language to any efficacy claim.
