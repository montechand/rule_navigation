...
- intent: Maintain consistent left-aligned reading rhythm across all text and CTAs on every background.

### rule_ibsrela_cta_section_image_right_layout
...
- intent: Standardize the CTA section as left-aligned text with any supporting visual placed on the right.
