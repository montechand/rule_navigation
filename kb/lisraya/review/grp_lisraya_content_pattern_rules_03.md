...
- class=copy_editorial scope=org_baseline hardness=soft_guidance polarity=should sections=None constraint=cardinality
...
- intent: Preserve emphasis hierarchy by reserving bold for takeaways and capping how much text is bolded.
...
- intent: Prevent over-emphasized, cluttered strings by limiting stacked emphasis devices.

### rule_lisraya_underline_italic_restrictions
...
- intent: Keep underline as a link affordance and restrict italic to structural uses, not emphasis.
